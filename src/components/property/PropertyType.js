    ...
    getSpaceFields(allowField){
        ...
        return(
            <>
                ...
                {( allowField == 'property_clear_height') ? <div className="col-xs-12 col-sm-6"><Input  disable = {disable} onChange={this.onPropertyChangeHanlder.bind(this)}  name="property_clear_height" label="Clear Height" value={property.clear_height}/></div> :''}
